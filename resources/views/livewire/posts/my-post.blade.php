<div class="div">
    ...
    <div class="container ">
        <div class="profile">
            <h2 class="mt-3 text-center" style="font-size: 23px; color:#000000;">{{Auth::user()->name}}'s Profile</h2>
        </div>
        <div class="post-body">
            <div class="col-md-6 " style="width: 560px">
                <div class=" shadow-md p-3 " id="write">
                    <button class="write-2 form-control" style="color:rgb(0, 0, 0);background-color: #3700ff;" data-toggle="modal" data-target="#click">+ Create new talk</button>
                </div>
            </div>
