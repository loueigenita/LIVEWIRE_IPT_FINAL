<div>
    <div class="container mt-3">
        ...
        @endif
        <div class='btn btn-primary btn-sm float-end mb-2'  style="background-color: #001aff; color:white;" data-toggle="modal" data-target="#modal-permissions"> + Create New Permission</div>
        <input type="search" class="form-control" style="width: 250px;" placeholder="Search" wire:model.lazy="search">
        <div class="card-body">
            <table class="table table-striped shadow text-center">
                <thead style="background-color:#000000; color:#f4f9ed;">
                    <tr>
                        <th>Name</th>
                        <th>Action</th>
                    </tr>
