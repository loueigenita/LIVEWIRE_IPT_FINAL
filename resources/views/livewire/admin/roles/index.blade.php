<div>
    <div class="container mt-3">
        ...
        @endif
        <div class='btn btn-primary btn-sm float-end mb-2'  style="background-color: #0400ff; color:white;" data-toggle="modal" data-target="#modal-roles"> + Create New Role</div>
        <input type="search" class="form-control" style="width: 200px;" placeholder="Search" wire:model.lazy="search">
        <div class="card-body">
